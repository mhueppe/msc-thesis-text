...
\begin{figure}[h!]
	...
	\begin{subfigure}[t]{0.495\linewidth}
		...
		\caption[Surface feature \gls{ks} distance of chemicals]{Differences of distributions for all surface features between chemicals.}
		\label{fig:ks_distance_all_surface}
	\end{subfigure}
	\caption[Distribution difference]{The figure shows the KS distance between the distributions of one chemical to every other chemical for the 15 most common compounds for sequence (\autoref{fig:ks_distance_all_sequence}) and surface (\autoref{fig:ks_distance_all_surface}) features. The KS distance was calculated for every feature independently. All distances were then averaged. }

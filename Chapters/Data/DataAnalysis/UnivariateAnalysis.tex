...
\begin{figure}[h!]
	...
	\end{subfigure}
	\caption[Most common compounds with concentrations]{The relative concentration ($w/v$ and $v/v$) at which different \glspl{peg} occur differs. The spread ($\pm$ 1 SD)differs as well with some \glspl{peg} having a higher spread of values (e.g. \gls{peg} 400) than others (e.g. \gls{peg} 20 000). The same holds for other compounds. In comparison buffers such as tris, HEPES, MES have both a lower average concentration as well as a much smaller spread than salts such as ammonium sulfate or sodium chloride/acetate/citrate.}

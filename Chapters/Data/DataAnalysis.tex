...
\subsubsection{Label}
After parsing it can be seen that the descriptions that do not contain any information about the chemical cocktail is \roughly 3.5 \%. They are very similar to entry 3PCA in that they only define the pH or temperature. 

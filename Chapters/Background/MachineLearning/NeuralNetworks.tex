...
Training neural networks is typically performed using gradient-based optimization, where parameters are updated using the gradient of the loss function with respect to the weights. The backpropagation algorithm efficiently computes these gradients by applying the chain rule of calculus through the network layers \citet{Schmidhuber2015}.

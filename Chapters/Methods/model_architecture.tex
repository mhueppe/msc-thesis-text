...
\caption{Simplified overview of the proposed two-tower architecture. Protein-related inputs are grouped and passed through the protein tower, while condition-related inputs are grouped and passed through the condition tower. The resulting embeddings are compared using a similarity-based scoring function to rank candidate conditions.}

...
\autoref{fig:bindingSitePrediction} shows downstream binding site predictions made from the ProteinMAE embedding. As seen the binding sites are very clear distinguished from the rest of the protein. The 

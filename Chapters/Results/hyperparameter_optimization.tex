...
\begin{figure}[h]
	...
	\caption[Model size influence on Performance]{Figure shows \gls{auc} and Top 1 score in relation to model size. The performance increases with more neurons until overfitting starts.}

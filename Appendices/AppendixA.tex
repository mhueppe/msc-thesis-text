...
\begin{lstlisting}[caption={Example file}, basicstyle=\small, label={lst:example_file}]
...
\hspace{0.5cm}
\begin{lstlisting}[caption={Feature example}, basicstyle=\small, label={lst:feature_example}]
	loop_

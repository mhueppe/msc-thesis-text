...
\begin{lstlisting}[caption=Optuna search setup, label=lst:optuna_study]
    "objective": "binary:logistic",
    "eval_metric": "aucpr",
    "tree_method": "hist",
    "device": "cpu",

    "learning_rate": suggest_float(1e-3, 3e-1, log=True),
    "max_depth": suggest_int(3, 10),
    "min_child_weight": suggest_float(1e-2, 1e2, log=True),
    "gamma": suggest_float(1e-8, 10.0, log=True),

    "subsample": suggest_float(0.5, 1.0),
    "colsample_bytree": suggest_float(0.5, 1.0),
    "colsample_bynode": suggest_float(0.5, 1.0),

    "reg_lambda": suggest_float(1e-3, 1e2, log=True),
    "reg_alpha": suggest_float(1e-8, 10.0, log=True),

    "max_bin": suggest_categorical([64, 128, 256, 512]),
    "n_estimators": 5000
\end{lstlisting}

...
\author{Michael \textsc{Hüppe}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\university{\href{https://www.uni-hamburg.de/}{Universtiy of Hamburg}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
Given the scarcity of reliable negative labels in crystallization data, this work adopts a contrastive learning framework to model the relationship between proteins and crystallization conditions. A two-tower architecture is proposed, where protein and condition representations are learned jointly in a shared embedding space and compared using a similarity-based scoring function. In addition, classical supervised learning approaches, including gradient boosting methods, are evaluated as baselines.

Experimental results demonstrate that the proposed approach captures meaningful relationships between protein features and crystallization conditions, enabling the ranking of candidate conditions for a given protein. While exact prediction of optimal conditions remains challenging due to the high dimensionality and inherent stochasticity of crystallization, the model shows potential to narrow down the experimental search space.
...
I am also grateful to Prof. Dr. Gordon Fabian Kern, for the support in machine learning and bioinformatics and his supervision in this thesis. \\
